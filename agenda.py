...
def date_command(date_input):
    ...
    temporalite = {
        'passé' : ['hier', 'avant-hier', 'il y a' + 'jour', 'lundi dernier', 'mardi dernier',
        'mercredi dernier', 'jeudi dernier', 'vendredi dernier', 'samedi dernier', 'dimanche dernier'
        'mois dernier', 'weekend dernier', 'semaine dernière'],

        'futur' : ['demain', 'dans' + 'jour', 'semaine prochaine', 'lundi prochain', 'mardi prochain', 
        'mercredi prochain', 'jeudi prochain', 'vendredi prochain', 'samedi prochain', 'dimanche prochain',
        'mois prochain', 'weekend prochain'],

        'autres' : ['ce matin', 'ce midi', 'cet après-midi', 'ce soir', 'cette nuit', 'ce week-end']
    }
    for temp in temporalite:
